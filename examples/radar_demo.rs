...
fn print_banner() {
    ...
    table
        ...
        .add_row(vec![
            ...
            Cell::new("Radar scope visualization").fg(Color::Green),
        ])
        .add_row(vec![
            Cell::new("Effect"),
            Cell::new("Sweeping scan mapping Z-Buffer to blips").fg(Color::Yellow),
        ]);
...
fn render_cube(fb: &mut Framebuffer, zb: &mut ZBuffer, cube: &Mesh, model: Mat4, view_proj: Mat4) {
    ...
    for tri_indices in &cube.indices {
        ...
        // Just use white as the base rendering color; radar handles the rest
...
impl WindowApp for RadarDemoApp {
    ...
    fn render(&mut self, _ctx: WindowContext<'_>) -> Result<(), Self::Error> {
        ...
        let offset = 3.0;
        let model2 = Mat4::translation(offset, 0.0, 0.0) * Mat4::rotation_y(-self.angle_y);
