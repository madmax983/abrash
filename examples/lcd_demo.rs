//! LCD / Gameboy Filter Demo
//!
//! Renders a rotating 3D lit cube and applies the LCD post-processing effect.
...
#[cfg(feature = "nova")]
use abrash_render::experimental::lcd::{LcdConfig, apply_lcd};
...
fn print_banner() {
    ...
    table
        ...
        .add_row(vec![
            ...
            Cell::new("Renders a rotating 3D cube with an LCD/Gameboy screen effect")
                .fg(Color::Green),
        ])
        .add_row(vec![
            Cell::new("Effect"),
            Cell::new("LCD pixelation and palette mapping").fg(Color::Yellow),
        ]);
...
impl LcdDemo {
    fn new() -> Result<Self, HostError> {
        ...
        Ok(Self {
            ...
            angle_x: 0.0,
            #[cfg(feature = "nova")]
            config: LcdConfig::default(),
        })
    }
}

impl WindowApp for LcdDemo {
    type Error = HostError;

    fn config(&self) -> WindowHostConfig {
        WindowHostConfig {
            title: "🌟 Nova: LCD Filter Demo".to_string(),
    ...
    fn render(&mut self, _ctx: WindowContext<'_>) -> Result<(), Self::Error> {
        ...
        self.framebuffer.clear(0xFF_EEEEEE);
        self.zbuffer.clear();
        ...
        #[cfg(feature = "nova")]
        {
            apply_lcd(&mut self.framebuffer, &self.config);
        }
...
fn main() {
    ...
    error_table
        ...
        .add_row(vec![
            Cell::new("Try running with:\ncargo run --example lcd_demo --features nova")
                .fg(Color::Green),
        ]);
...
fn main() {
    print_banner();
    run_windowed(LcdDemo::new().unwrap());
}
