...
fn print_banner() {
    println!("\n{}", "📐 Blueprint Filter Demo".bold().cyan());
    println!("{}", "=====================".dark_grey());
    ...
    table
        ...
        .add_row(vec![
            ...
            Cell::new("Real-time technical drawing effect").fg(Color::Green),
        ])
        .add_row(vec![
            Cell::new("Renderer"),
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    print_banner();
    let mut window = Window::new("Abrash - Blueprint Filter", WIDTH, HEIGHT)?;
    ...
    let blueprint_config = BlueprintConfig::default();
    ...
    while window.is_open() {
        ...
        apply_blueprint(&mut framebuffer, &blueprint_config);
