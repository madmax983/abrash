...
use abrash::experimental::kinect_depth::{KinectDepthConfig, apply_kinect_depth};
...
const TITLE: &str = "Abrash - Kinect Depth Demo (Nova)";

fn print_banner() {
    println!("\n{}", "🎥 Kinect Depth Demo".bold().cyan());
    println!("{}", "=====================".dark_grey());
    ...
    table
        ...
        .add_row(vec![
            ...
            Cell::new("Simulates Kinect/structured light depth sensor").fg(Color::Green),
        ])
        .add_row(vec![
            Cell::new("Effect"),
            Cell::new("Post-process z-buffer depth map").fg(Color::Yellow),
        ]);
...
impl WindowApp for KinectDepthApp {
    ...
    fn render(&mut self, _ctx: WindowContext<'_>) -> Result<(), Self::Error> {
        ...
        apply_kinect_depth(&mut self.framebuffer, &self.zbuffer, &config);
...
fn main() {
    print_banner();
    run_windowed(KinectDepthApp::new().unwrap());
}
