//! Abrash Graphics Demo - Falling Sand Mashup
//!
//! Demonstrates the experimental Falling Sand cellular automaton
//! running on top of a rendered 3D scene.
...
use abrash::experimental::falling_sand::FallingSand;

const WIDTH: u32 = 800;
const HEIGHT: u32 = 600;
const TITLE: &str = "Abrash - Falling Sand Mashup";
...
fn print_banner() {
    println!("\n{}", "🌟 Falling Sand Mashup".bold().yellow());
    println!("{}", "=======================".dark_grey());
    ...
    table
        ...
        .add_row(vec![
            ...
            Cell::new("Falling sand cellular automaton collides with a 3D scene").fg(Color::Green),
        ]);
...
impl FallingSandApp {
    fn new() -> Result<Self, HostError> {
        ...
        Ok(Self {
            ...
            angle_y: 0.0,
            angle_x: 0.0,
            falling_sand: FallingSand::new(WIDTH as usize, HEIGHT as usize),
        })
    }
}
...
impl WindowApp for FallingSandApp {
    ...
    fn resize(
        ...
        // Re-create the falling sand grid on resize. Sand is wiped.
        self.falling_sand = FallingSand::new(width as usize, height as usize);
        Ok(())
    }
    ...
    fn update(&mut self, _ctx: WindowContext<'_>) -> Result<(), Self::Error> {
        ...
        for _ in 0..steps {
            ...
            // Emit sand continuously
            self.falling_sand.emit_sand(15, 0xFFEEDD82); // Sand color
        }
        Ok(())
    }
    ...
    fn render(&mut self, _ctx: WindowContext<'_>) -> Result<(), Self::Error> {
        ...
        // Apply falling sand
        self.falling_sand
            .update_and_draw(&mut self.framebuffer, clear_color);
...
fn main() -> Result<(), HostError> {
    print_banner();
    run_windowed(FallingSandApp::new()?)
}
