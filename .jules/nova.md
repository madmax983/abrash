...
## [Falling Sand]
**Concept:** A gravity-based cellular automata simulation on a 2D grid that supports falling sand, spreading water, and static walls with collision and fluid displacement.
**Fate:** Implemented
**Lesson:** Processing bottom-up is crucial for cellular automata to prevent objects from teleporting downwards. Handling swaps using `old_dst_mat == Material::Water` correctly allows sand to drop through water instead of destroying it.
