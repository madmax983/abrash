...
## [Lens Distortion]
**Concept:** A post-processing effect that applies radial barrel or pincushion distortion to the framebuffer, simulating camera lens imperfections.
**Fate:** Implemented
**Lesson:** Complex floating point math per-pixel (sqrt, mult) benefits hugely from AVX2 SIMD vectorization.
