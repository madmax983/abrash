...
## [Synthwave Backdrop Filter]
**Concept:** A retro "Outrun" synthwave background generator that creates a gradient sky, a glowing sun with horizontal sine-wave cutouts, and a perspective wireframe grid that scrolls over time.
**Fate:** Implemented
**Lesson:** Using simple sine/mod operations against the normalized Y-axis provides an extremely fast and stylistic way to create horizontal cutouts without complex boolean geometry or polygon rendering.
