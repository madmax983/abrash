...
**Concept:** A generator that renders mathematical strange attractors (like Peter de Jong and Clifford attractors) into a 2D framebuffer. It iterates complex trigonometric equations millions of times, mapping particle density to a logarithmic color gradient to visualize chaotic systems.
**Fate:** Implemented
**Lesson:** Using a logarithmic density mapping ensures that both sparse outer strands and dense chaotic cores are visible, preventing oversaturation of the center.
