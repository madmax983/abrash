...
## [Seam Carving Filter]
**Concept:** A post-processing effect that performs content-aware image resizing by finding and removing the lowest energy vertical seams.
**Fate:** Implemented
**Lesson:** Using a cumulative energy map and dynamic programming efficiently finds the least important pixels. The main challenge is properly shifting pixels across rows into a new, smaller framebuffer while preserving edges.
