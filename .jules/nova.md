...
## [Strange Attractor]
**Concept:** A mathematical renderer that iterates Clifford attractor formulas and plots chaotic trajectories on the screen.
**Fate:** Implemented
**Lesson:** Iterating points via sine/cosine and accumulating pixel intensity enables beautiful chaos visualization. Extracting scale and avoiding heavy structs ensures smooth high-iteration execution.
