...
## [Motion Blur Filter]
**Concept:** A post-processing effect that blends the current frame with previous frames to create a sense of speed and persistence.
**Fate:** Implemented
**Lesson:** Encapsulating temporal state in a dedicated struct prevents test flakiness and is cleaner than using thread locals.
