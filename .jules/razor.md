...
## [Reduction]
**Bloat:** `CoordMode` enum in `abrash-gpu-render` that was completely unused (dead code).
**Cut:** Removed the `CoordMode` enum entirely to adhere to YAGNI and KISS principles.
**Saved:** Reduced cognitive load and removed unused dead code.
