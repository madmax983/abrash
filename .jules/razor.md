...
## [Reduction]
**Bloat:** Missing Error docs for procedural pattern generation.
**Cut:** Added proper `# Errors` sections to `plasma`, `xor_pattern`, `grid_pattern`, and `white_noise` functions. Inlined formatting arguments in benchmark code for `format!` macro.
**Saved:** Suppressed clippy warnings.
