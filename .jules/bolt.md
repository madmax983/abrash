...
**[Eliding slow floating point equal checks]
...
**Action:** Replace `depth == f32::INFINITY` with `depth.to_bits() == 0x7F80_0000` in the hot inner loop of `apply_heat_vision`. Always add an explanatory comment (`// 0x7F80_0000 is f32::INFINITY`) to avoid magic numbers.
