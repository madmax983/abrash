...
pub struct TileBins {
    ...
    pub tris: Vec<u32>,
    /// ⚡ Bolt: Keeps track of which bins were actually used to avoid clearing the entire array.
...
impl TileBins {
    ...
    pub fn new(num_tiles: usize) -> Self {
        ...
        Self {
            ...
            used_bins: Vec::with_capacity(num_tiles),
        }
    }

    /// Clears the bin structure for the next frame.
    pub fn clear(&mut self) {
        // ⚡ Bolt: Only clear the heads and tails that were actually used
        for &idx in &self.used_bins {
