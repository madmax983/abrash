...
impl TileRenderer {
    #[cfg(not(feature = "parallel"))]
    #[inline(always)]
    fn merge_rendered_tile_sequential(
        tx: u32,
        ty: u32,
        width: u32,
        height: u32,
        ...
        let (y_min, y_max) = if has_integrated_clear {
        ...
        Self::merge_tile_direct(tile_pixels, tile_depths, fb, zb, &bounds);
    }

    #[cfg(feature = "parallel")]
    #[inline(always)]
    fn merge_rendered_tile_parallel(
        tx: u32,
        ty: u32,
        width: u32,
        height: u32,
                ...
                for ty in 0..self.tiles_y {
                    for tx in 0..self.tiles_x {
                        if let Some((clear_y_min, clear_y_max)) = render_single_tile(
                            ...
                            Self::merge_rendered_tile_sequential(
                                tx,
                                ty,
                                self.width,
                                self.height,
                        ...
                        .for_each(|(tx, ty)| {
                            ...
                            TILE_BUFFER.with(|buf| {
                                ...
                                if let Some((clear_y_min, clear_y_max)) = render_single_tile(
                                    ...
                                    Self::merge_rendered_tile_parallel(
                                        tx,
                                        ty,
                                        width,
                                        height,
