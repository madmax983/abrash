...
//! 2.  **Clipping**: Triangles are clipped against the view frustum (handled by [`abrash_core::clipping`]).
...
pub use self::texture::{
    ...
    fill_quad_textured, fill_triangle_laplacian_blend, fill_triangle_normal_mapped,
