...
impl BaseTriangleSetup {
    ...
    #[inline(always)]
    pub(crate) fn calc_dy(&self, du: f32, dv: f32) -> f32 {
        (du * self.vx - self.ux * dv) * self.inv_nz
    }
}
