...
fn quantize_color(color: u32, levels: u32) -> u32 {
    ...
    // ⚡ Bolt: Use u64 for scaled integer math to prevent overflow panics
    let qr = (((r as u64 * levels_minus_1 as u64 + 127) / 255 * 255) / safe_divisor as u64) as u32;
    let qg = (((g as u64 * levels_minus_1 as u64 + 127) / 255 * 255) / safe_divisor as u64) as u32;
    let qb = (((b as u64 * levels_minus_1 as u64 + 127) / 255 * 255) / safe_divisor as u64) as u32;

    a | (qr.min(255) << 16) | (qg.min(255) << 8) | qb.min(255)
}
