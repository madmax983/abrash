        ...
        if is_pure_ascii {
            ...
            return LSYSTEM_BUFFERS.with(|bufs| {
                ...
                for _ in 0..iterations {
                    ...
                    for &b in &*current_bytes {
                        ...
                        if next_bytes.len() > self.max_capacity {
                            return Err(crate::experimental::error::Error::CapacityExceeded);
                        }
                    }
                ...
                std::str::from_utf8(current_bytes)
                    ...
                    .map_err(|_| crate::experimental::error::Error::Utf8DecodeError)
            });
        }
            ...
            match c {
                ...
                b'[' => {
                    if self.stack.len() > 1_000 {
                        return Err(crate::experimental::error::Error::StackOverflow);
                    }
                ...
                b']' => {
                    if let Some(state) = self.stack.pop() {
                        ...
                        return Err(crate::experimental::error::Error::StackUnderflow);
                    }
                }
