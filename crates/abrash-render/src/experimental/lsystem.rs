        ...
        if is_pure_ascii {
            ...
            return LSYSTEM_BUFFERS.with(|bufs| {
                ...
                std::str::from_utf8(current_bytes)
                    ...
                    .map_err(|_| crate::experimental::error::Error::General("L-System utf8 decoding error"))
            });
        }
            ...
            match c {
                ...
                b'[' => {
                    if self.stack.len() > 1000 {
                        return Err(crate::experimental::error::Error::StackOverflow("L-System stack overflow"));
                    }
                ...
                b']' => {
                    if let Some(state) = self.stack.pop() {
                        ...
                        return Err(crate::experimental::error::Error::StackUnderflow("L-System stack underflow"));
                    }
                }
