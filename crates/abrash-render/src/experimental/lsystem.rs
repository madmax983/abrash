...
impl LSystem {
    ...
    pub fn expand(&self, iterations: usize) -> Result<String, &'static str> {
        ...
        // severe initialization overhead.
        // ⚡ Bolt: Replaced `String::new()` and `.push_str()` with `self.axiom.clone()` to avoid
        // the redundant initialization of an empty string buffer and immediate capacity resizing overhead.
