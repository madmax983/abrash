...
pub struct Turtle {
    ...
    pub right: Vec3,
    /// The distance to move forward for drawing operations.
    pub segment_length: f32,
    /// The radius of the drawn segments (for mesh generation).
    pub segment_radius: f32,
    /// The angle (in radians) applied by rotation commands.
    pub turn_angle: f32,
