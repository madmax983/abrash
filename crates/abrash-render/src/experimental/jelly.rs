...
impl SoftBody {
    ...
    pub fn new(mesh: Mesh, mass: f32, stiffness: f32, damping: f32) -> Result<Self, String> {
        ...
        // ⚡ Bolt: Replaced std::collections::HashSet with foldhash::HashSet for simple integer pair deduplication. avoiding SipHash overhead significantly speeds up SoftBody mesh processing.
