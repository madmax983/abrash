...
pub fn decode_message(fb: &Framebuffer) -> Option<String> {
    ...
    // ⚡ Bolt: Eliminate `Vec::push` capacity checks by allocating an exact vector of zeroes
    // and mutating it directly. We keep standard bounds checks for memory safety.
