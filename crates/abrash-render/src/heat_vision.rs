...
unsafe fn apply_heat_vision_simd(
    ...
    while i + 8 <= len {
        ...
        // By rewriting this way we use FMA natively if compiled with target-cpu=native, or at least avoid sub before mul
        #[cfg(target_feature = "fma")]
        let t_f32 = std::arch::x86_64::_mm256_fmsub_ps(depth_val, scale_vec, offset_vec);
