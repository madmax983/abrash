...
/// Generates a mesmerizing plasma procedural texture.
///
/// # Errors
///
/// Returns an error if the underlying texture buffer fails to allocate memory for the requested dimensions.
