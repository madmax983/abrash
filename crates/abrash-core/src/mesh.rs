...
impl Mesh {
    ...
    pub fn sphere(radius: f32, stacks: u32, sectors: u32) -> Self {
        ...
        let triangle_count = (stacks * sectors * 2) as usize;
    ...
    pub fn plane(size: f32, subdivisions: u32) -> Self {
        ...
        let vertex_count = ((divs + 1) * (divs + 1)) as usize;
        let triangle_count = (divs * divs * 2) as usize;
    ...
    pub fn cylinder(radius: f32, height: f32, sectors: u32, stacks: u32) -> Self {
        ...
        let vertex_count = ((stacks + 1) * (sectors + 1) + 2 * (sectors + 1)) as usize;
        let triangle_count = (stacks * sectors * 2 + 2 * sectors) as usize;
    ...
    pub fn torus(
        ...
        let vertex_count = ((maj + 1) * (min + 1)) as usize;
        let triangle_count = (maj * min * 2) as usize;
