...
impl Mesh {
    ...
    pub fn sphere(radius: f32, stacks: u32, sectors: u32) -> Self {
        ...
        let index_count = (stacks * sectors * 6) as usize;
    ...
    pub fn plane(size: f32, subdivisions: u32) -> Self {
        ...
        let index_count = (divs * divs * 6) as usize;
    ...
    pub fn cylinder(radius: f32, height: f32, sectors: u32, stacks: u32) -> Self {
        ...
        let vertex_count = ((stacks + 1) * (sectors + 1) + 2 + sectors * 2) as usize;
        let index_count = (stacks * sectors * 6 + sectors * 6) as usize;
    ...
    pub fn torus(
        ...
        let index_count = (maj * min * 6) as usize;
