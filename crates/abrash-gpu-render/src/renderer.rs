...
impl GpuRenderer {
    ...
    fn encode_rt_shadow_pass(
        ...
        // ⚡ Bolt: Use `Vec::with_capacity` to pre-allocate memory for all potential draw instances.
        // This eliminates unnecessary dynamic heap reallocations per frame on this hot path.
