...
impl AbrashBackend {
    ...
    ///
    /// ⚡ Performance Note: Takes ownership of `Mesh` instead of borrowing it to avoid an O(N)
    /// heap allocation and cloning overhead when registering initial geometry.
    ///
    /// # Panics
    ///
