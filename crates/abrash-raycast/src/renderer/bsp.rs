...
mod tests {
    ...
    pub fn create_mock_textures() -> BspTextureCache {
        ...
        // Wall column: 128 texels, all palette index 1
            ...
            BspTextureCache {
                wall_column_data,
                flat,
                colormap_data: colormap_data.to_vec(),
    ...
    fn draw_wall_column_fills_pixels() {
        ...
        let textures = create_mock_textures();
    ...
    pub fn create_integration_map() -> BspMapData {
    ...
    fn render_bsp_view_does_not_panic() {
        let mut fb = Framebuffer::new(320, 200).unwrap();
        let mut zbuf = ZBuffer::new(320, 200).unwrap();
        let map = create_integration_map();
        let textures = create_mock_textures();
