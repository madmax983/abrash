...
pub enum Side {
    /// The face pointing North (-Y direction in some spaces).
    North,
    /// The face pointing South (+Y direction in some spaces).
    South,
    /// The face pointing East (+X direction in some spaces).
    East,
    /// The face pointing West (-X direction in some spaces).
    West,
}
