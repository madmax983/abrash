...
pub enum Easing {
    ...
    Linear,
    /// Accelerates from zero velocity (e.g., quadratic ease in).
    EaseIn,
    /// Decelerates to zero velocity (e.g., quadratic ease out).
    EaseOut,
    /// Accelerates from zero and decelerates back to zero (e.g., quadratic ease in-out).
    EaseInOut,
