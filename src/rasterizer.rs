...
mod tests {
    ...
    #[test]
    fn edge_walker_z_conversion() {
        // Test that EdgeWalker correctly initializes z
        ...
        let expected_dz_dy = (2.0 - 1.0) / 100.0;
    ...
    fn edge_walker_step_accumulates_correctly() {
        ...
        // The ideal would be 1.5
        assert!((walker.z - 1.5).abs() < 0.0001);
    }
