...
pub fn fill_triangle_textured(
    ...
    for i in 0..clipped.count {
        ...
        // Optimization: inv_w is already calculated in project_to_screen_optimized
        ...
        // Sort by y
        // We need to keep track of all attributes (p, u, v)
        // q (inv_w) is already stored in p (ScreenPoint)
        let mut verts = [
            (p0_orig, u0, v0_val),
            (p1_orig, u1, v1_val),
            (p2_orig, u2, v2_val),
