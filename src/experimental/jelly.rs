...
impl SoftBody {
    ...
    pub fn new(mesh: Mesh, mass: f32, stiffness: f32, damping: f32) -> Result<Self, String> {
        ...
        // ⚡ Bolt Optimization: Pre-allocate capacities based on the theoretical maximum number of edges
        // to avoid costly dynamic heap reallocations during graph traversal.
