...
Keyboard: Interactive",
    ...
    Demo {
        name: "Kintsugi Filter",
        category: DemoCategory::Simulation,
        description: "Repairs edges with gold while desaturating the rest.",
        instructions: "Watch the procedural geometry.",
        example_name: "kintsugi_demo",
    },
];
