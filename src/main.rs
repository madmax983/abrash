...
fn is_nova_example(example_name: &str) -> bool {
    example_name == "cloth_demo" || example_name == "raytracer_demo" || example_name == "vision_demo" || example_name == "pixel_sort_demo" || example_name == "directional_blur_demo" || example_name == "god_rays_demo" || example_name == "jelly_demo"
}
