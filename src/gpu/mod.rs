            ...
            triangles
                ...
                .map(|triangle| abrash_gpu::PreparedTriangleInput {
                    ...
                    p0_fixed: abrash_gpu::VertexFixedInput {
                        x: triangle.p0_fixed.x,
                        y: triangle.p0_fixed.y,
                        z: triangle.p0_fixed.z,
                    },
                    p1_fixed: abrash_gpu::VertexFixedInput {
                        x: triangle.p1_fixed.x,
                        y: triangle.p1_fixed.y,
                        z: triangle.p1_fixed.z,
                    },
                    p2_fixed: abrash_gpu::VertexFixedInput {
                        x: triangle.p2_fixed.x,
                        y: triangle.p2_fixed.y,
                        z: triangle.p2_fixed.z,
                    },
                    dz_dx: triangle.dz_dx,
                    long_edge_is_left: triangle.long_edge_is_left,
                    color: triangle.color,
                    aabb_min_x: triangle.aabb_min_x,
                    aabb_min_y: triangle.aabb_min_y,
                    aabb_max_x: triangle.aabb_max_x,
                    aabb_max_y: triangle.aabb_max_y,
