...
pub(crate) mod edge_walker;
pub(crate) mod gradients;

// Re-export for internal use (e.g. tile_renderer)
pub(crate) use edge_walker::{EdgeWalker, PerspectiveTextureEdgeWalker};
pub use gradients::PerspectiveTextureGradients;

use self::edge_walker::{GouraudEdgeWalker, PhongEdgeWalker};
use self::gradients::{GouraudGradients, PhongGradients};
