        ...
        while i + 8 <= len {
            ...
            if ge_bits != 0xFF {
                ...
                if _mm256_movemask_ps(mask_z) != 0 {
                    ...
                    // Hoisted identical UV clamping calculations out of the conditional branch.
                    // This zero-cost abstraction eliminates duplicate conditional code, reducing
                    // the instruction footprint inside the hot inner SIMD loop.
