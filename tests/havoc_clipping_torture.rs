...
// Helper to lerp TestVertex
fn lerp_test_vertex(a: TestVertex, b: TestVertex, t: f32) -> TestVertex {
    TestVertex {
...
proptest! {
    ...
    fn test_clip_triangle_torture(
        ...
        let _ = clip_triangle_to_frustum(v0, v1, v2, get_pos, lerp_test_vertex);
    }
