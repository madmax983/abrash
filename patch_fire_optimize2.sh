cat << 'INNER_EOF' > patch_fire_optimize2.diff
...
+
+            // Avoid bounds checks manually by structuring loop
...
patch crates/abrash-render/src/experimental/fire.rs < patch_fire_optimize2.diff
