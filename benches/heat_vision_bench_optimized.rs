...
fn bench_heat_vision_optimized(c: &mut Criterion) {
    let mut group = c.benchmark_group("Heat Vision Optimized");
...
criterion_group!(benches, bench_heat_vision_optimized);
