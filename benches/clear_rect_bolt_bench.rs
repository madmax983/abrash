...
fn bench_clear_rect_1080p(c: &mut Criterion) {
    ...
    c.bench_function("framebuffer/clear_rect_bolt_1080p", |b| {
        b.iter(|| {
            fb.clear_rect(
                black_box(100),
                black_box(100),
...
fn bench_clear_rect_4k(c: &mut Criterion) {
    ...
    c.bench_function("framebuffer/clear_rect_bolt_4k", |b| {
        b.iter(|| {
            fb.clear_rect(
                black_box(500),
                black_box(500),
...
fn bench_zbuffer_clear_rect_1080p(c: &mut Criterion) {
    ...
    c.bench_function("zbuffer/clear_rect_bolt_1080p", |b| {
        b.iter(|| {
            zb.clear_rect(
                black_box(100),
                black_box(100),
...
fn bench_zbuffer_clear_rect_4k(c: &mut Criterion) {
    ...
    c.bench_function("zbuffer/clear_rect_bolt_4k", |b| {
        b.iter(|| {
            zb.clear_rect(
                black_box(500),
                black_box(500),
