...
fn clear_rect_framebuffer_original(
    fb: &mut Framebuffer,
    x: i32,
    y: i32,
    width: u32,
...
fn clear_rect_framebuffer_optimized(
    fb: &mut Framebuffer,
    x: i32,
    y: i32,
    width: u32,
...
fn bench_clear_rect_iterator(c: &mut Criterion) {
    let mut fb = Framebuffer::new(3840, 2160).unwrap();
    let mut group = c.benchmark_group("clear_rect_iterator");

    group.bench_function("framebuffer_original_4k", |b| {
        b.iter(|| {
            clear_rect_framebuffer_original(
                &mut fb,
                black_box(100),
                black_box(100),
                black_box(2000),
    ...
    group.bench_function("framebuffer_optimized_4k", |b| {
        b.iter(|| {
            clear_rect_framebuffer_optimized(
                &mut fb,
                black_box(100),
                black_box(100),
                black_box(2000),
...
criterion_group!(benches, bench_clear_rect_iterator);
