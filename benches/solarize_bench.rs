...
pub fn apply_solarize_simd_avx2(pixels: &mut [u32], threshold: u8) {
    #[cfg(all(target_arch = "x86_64", feature = "simd"))]
    {
        if std::is_x86_feature_detected!("avx2") {
            ...
            let simd_len = len & !7;
            unsafe {
                use std::arch::x86_64::{__m256i, _mm256_and_si256, _mm256_cmpgt_epi8, _mm256_loadu_si256, _mm256_set1_epi32, _mm256_set1_epi8, _mm256_storeu_si256, _mm256_sub_epi8, _mm256_xor_si256};
                let th_val = _mm256_set1_epi8((threshold.wrapping_sub(128)) as i8); // Offset by 128 for signed compare
