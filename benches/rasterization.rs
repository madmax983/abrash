...
fn bench_fill_triangle_3d_micro(c: &mut Criterion) {
    c.bench_function("fill_triangle_3d_micro", |b| {
        let mut fb = Framebuffer::new(800, 600).unwrap();
        let mut zb = ZBuffer::new(800, 600).unwrap();

        // A micro triangle (sub-pixel width likely)
        // Screen is 800x600.
        // NDC 0.001 is 0.4 pixels.
        let v0 = (Vec3::new(0.0, 0.002, -2.0), 1.0);
        let v1 = (Vec3::new(-0.001, -0.002, -2.0), 1.0);
        let v2 = (Vec3::new(0.001, -0.002, -2.0), 1.0);
