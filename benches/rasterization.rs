...
use abrash::pipeline::{fill_triangle_3d, fill_triangle_gouraud};
...
fn bench_fill_triangle_gouraud(c: &mut Criterion) {
    c.bench_function("fill_triangle_gouraud", |b| {
        ...
        let v0 = ((Vec3::new(0.0, 2.0, -2.0), 1.0), Vec3::new(1.0, 0.0, 0.0));
        let v1 = ((Vec3::new(-2.0, -2.0, -2.0), 1.0), Vec3::new(0.0, 1.0, 0.0));
        let v2 = ((Vec3::new(2.0, -2.0, -2.0), 1.0), Vec3::new(0.0, 0.0, 1.0));
